...
/* patch in the custom startup routine before entering main. FIXME: there
 * could be a more generic way to do this than just #define-ing around */
#define main _pre_main
